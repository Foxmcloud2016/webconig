...
$director_o = 'Norte Monica';
$dni_dir_o = '43214324';
$escuela_nombre_o = 'Colegio Provincial Soberania Nacional';
$distrito_o = 'NORTE';
$ciudad_o = 'Rio Grande';
$domicilio_o = 'Prefectura naval argentina 1151';
$adulto = 'Roberto Carlos';
$dni_adulto = '382394003';
$calle = 'Prefectura naval argentina';
$numero = '870';
$piso = '1°';
$depto = 'B';
$ciudad_o = 'Rio Grande';
$dni_comodatario = '37909123';
$curso = '4°';
$division = '1° ESO';
$turno = 'Tarde';
$marca = 'NBX';
...
$alumno = 'GUSTAVO EZEQUIEL TRONCOSO';
...
// $pdf->WriteFlowingBlock( $dni_adulto );
// $pdf->SetFont('Arial','',11);
// $pdf->WriteFlowingBlock( ', DNI N° ' );
// $pdf->SetFont('Arial','B',11);
// $pdf->WriteFlowingBlock( $dni_adulto );
// $pdf->SetFont('Arial','',11);
// $pdf->WriteFlowingBlock( ', DNI N° ' );
