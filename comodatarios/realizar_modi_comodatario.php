<?php
	...
	*/
	$querymodi="UPDATE COMODATARIOS SET DNI_COM = '$dni' , APEYNOM = '$apeynom', DNI_ADULTO = '$dni_adulto', APEYNMOM_A = '$apeynom_a', MARCA = '$marca', SERIE = '$serie' WHERE ID_COMODATARIO = '$id_comodatario' " ;
	//$Resultado = $conexion->query($querymodi);
	$result = mysqli_query($conexion, "UPDATE COMODATARIOS SET DNI_COM = '$dni' , APEYNOM = '$apeynom', DNI_ADULTO = '$dni_adulto', APEYNOM_A = '$apeynom_a', MARCA = '$marca', SERIE = '$serie' WHERE ID_COMODATARIO = '$id_comodatario' ") or die("Error " .mysqli_error($conexion));
