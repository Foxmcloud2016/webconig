...
CUARTA: El presente contrato tendrá vigencia desde la firma del mismo y hasta el momento en que el estudiante haya obtenido el título que acredite el cumplimiento del nivel secundario en las modalidades orientada, artística o técnico profesional, habiendo cumplimentado todas sus obligaciones académicas, a más tardar en las fechas de los exámenes de marzo siguiente al año en que finalizó la cursada. En este caso, finaliza el Contrato de Comodato y la laptop en su posesión pasa a ser de propiedad del egresado.
