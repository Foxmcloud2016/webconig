...
DECIMOTERCERA: Para cualquier cuestión judicial, de común acuerdo las partes quedan sometidas a la competencia de los Juzgados Ordinarios de Primera Instancia con competencia en lo Contencioso Administrativo.
  ...
  $pdf->SetFont('Arial','',11);
  $pdf->WriteFlowingBlock( iconv('UTF-8', 'windows-1252', ', en su carácter de Director/Rector/a del Instituto Superior de Formación Docente ') );
  $pdf->SetFont('Arial','B',11);
  ...
  $pdf->WriteFlowingBlock( iconv('UTF-8', 'windows-1252', $ciudad_o) );
  $pdf->SetFont('Arial','',11);
  $pdf->WriteFlowingBlock( iconv('UTF-8', 'windows-1252', ', Provincia de Tierra del Fuego en su carácter de alumno en adelante “EL COMODATARIO”,  ambos mayores de edad y hábiles para este acto, convienen en celebrar el presente CONTRATO DE COMODATO, sujeto a las siguientes cláusulas y condiciones:') );
  $pdf->SetFont('Arial','B',11);
  ...
  $pdf->SetFont('Arial','',11);
  $pdf->WriteFlowingBlock( iconv('UTF-8', 'windows-1252', ' la cual deberá ser asociada, a fin de cumplir con el protocolo de seguridad antirrobo, al servidor del Instituto Superior de Formación Profesional ') );
  $pdf->SetFont('Arial','B',11);
  $pdf->WriteFlowingBlock( iconv('UTF-8', 'windows-1252', $escuela_nombre_o) );
  $pdf->SetFont('Arial','',11);
