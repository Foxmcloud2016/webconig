...
//Acá traigo datos del colegio para guardarlos en variables de sesión y que luego serviran en otros archivos
	...
	$_SESSION['tipo_colegio'] = $fila['TIPO_COLEGIO'];
...
//consulta a la DDBB si dichos usuarios y pass estan almacenados en ella
	...
	$query_colegio = "SELECT COLEGIO, TIPO_COLEGIO FROM COLEGIOS WHERE ID_COLEGIO = '".$_POST['colegio']."'";
...
if (is_null($_SESSION['usuario']['USUARIO']) or is_null($_SESSION['contrasenia']['PASS']) or empty($_SESSION['colegio']) ) {
